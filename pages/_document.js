    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <meta name="description" content="The Stage nft base website " />
          <meta
            name="keywords"
            content="react,material,kit,application,landing & corporate,template"
          />
          <meta name="author" content="The Stage" />

          <link rel="apple-touch-icon" sizes="180x180" href="/assets/images/svgs/stagelogo.svg" />
          <link
            rel="icon"
            type="image/png"
            sizes="32x32"
